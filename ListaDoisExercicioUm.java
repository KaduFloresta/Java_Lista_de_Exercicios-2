...
public class ListaDoisExercicioUm {
    public static void main(String[] args) {
        ...
        /*
         * Exercicio1 - MEDIA DE 3 NOTAS 1) Crie um programa que receba três notas
         * calcule a média e diga se foi aprovado (`(nota1 + nota2 + nota3 / 3)`) e
         * (`média maior que 7 para ser aprovado`).
         */
